 ...
 * - Funnel videos autoplay muted and inline where the browser allows it.
 * - Controls stay visible so the viewer can tap for sound.
      ...
      <section className={`w-full ${className ?? ""}`} aria-label={label}>
        ...
        {autoplay ? (
          <p className="mt-2 text-center text-[11px] text-muted-foreground sm:text-xs">
            Video starts muted on mobile. Tap the player for sound.
          </p>
        ) : null}
      </section>
    );
