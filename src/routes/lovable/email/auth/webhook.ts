            ...
            signup: {
              ...
              render: (data) =>
                React.createElement(SignupEmail, {
                  ...
                  // Never Supabase's verify endpoint: it would consume the
                  // one-use token before our same-origin callback can prove
                  // email ownership. Throws (fails closed) if absent.
                  confirmationUrl: buildJoinVerificationUrl(data),
                }),
            },
            invite: {
