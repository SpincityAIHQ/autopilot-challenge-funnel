  ...
  head: () => ({
    meta: [
      { title: "8-Week Mentorship & Work-Along — Application" },
      {
        name: "description",
        content:
          "Application-based eight-week mentorship. Separate from the 10-slot Strategy Intensive.",
      },
    ],
  }),
  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-16">
      ...
      <p className="mt-2 text-xs text-muted-foreground">
        The Mentorship is a separate offer from the Strategy Intensive. Applying
        does not reserve a seat or charge a card.
      </p>
