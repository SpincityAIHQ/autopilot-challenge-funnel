...
function Privacy() {
  return (
    <main className="mx-auto max-w-3xl px-5 py-16 text-muted-foreground">
      ...
      <h1 className="mt-3 font-display text-2xl text-foreground">Privacy Policy</h1>
      ...
      <div className="prose prose-invert mt-8 max-w-none text-sm leading-relaxed">
        ...
        <p className="mt-4">
          For questions, contact <a className="underline" href="mailto:Info@NuAmenti.com">Info@NuAmenti.com</a>.
        </p>
      </div>
    </main>
  );
