import { LESSONS, coverage, type LessonProgress } from "./academy";
    ...
    for (const p of ordered) {
      ...
      if (
        ...
        return {
          ...
          message: `Your player recorded ${coverage(p.intervals, p.duration)}% coverage of this lesson. Continue the recording, then check your understanding.`,
        };
    }
  return null;
}
