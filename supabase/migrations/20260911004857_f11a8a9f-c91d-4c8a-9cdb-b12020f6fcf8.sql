...
REVOKE ALL ON FUNCTION public.academy_claim_outbox(integer, text[]) FROM anon;
REVOKE ALL ON FUNCTION public.academy_claim_outbox(integer, text[]) FROM authenticated;
